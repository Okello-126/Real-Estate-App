...
import 'dummypagewithlocation.dart';
...
class DummyNotificationsScreen extends StatefulWidget {
  Query collection;
  String transaction;
  String text, type, whatfor;

  DummyNotificationsScreen(
...
FilterForLocation filter2 = FilterForLocation();
TextEditingController _controller = TextEditingController();
bool onlocationspage = true;
ManageTextfield searchinglocations2 = ManageTextfield();

class _NotificationsScreenState extends State<DummyNotificationsScreen> {
  @override
                ...
                SizedBox(
                  ...
                  child: Padding(
                    ...
                    child: TextField(
                      ...
                      onSubmitted: (value) {
                        setState(() {
                          searchinglocations2.text = _controller.text;
                          searchinglocations2.type = widget.type;
                          searchinglocations2.whatfor = widget.whatfor;
                              ...
                              MaterialPageRoute(
                                builder: (context) => NotificationsScreen(
                                    FirebaseFirestore.instance
                                        .collection(searchinglocations2.type +
                                            searchinglocations2.whatfor)
                                        .where('street',
                                            isEqualTo:
                                                searchinglocations2.text),
                                    widget.transaction,
                                    searchinglocations2.text,
                                    searchinglocations2.type,
                                    searchinglocations2.whatfor),
                              ));
                        });
                      },
                                            ...
                                            onChanged: (RangeValues value) {
                                              setState(() {
                                                ...
                                                filter2.startprice =
                                                    selectedRange.start
                                                        .toDouble();
                                                filter2.endprice = selectedRange
                                                    .end
                                                    .toDouble();
                                              });
                                            },
